...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2018 at 08:22 AM
...
('8016174640924308', '412131', '231241234', '2134123412', 12314, '3241234', '3241234', '1243124', '40008', '0', '2017-11-29Opened');

-- --------------------------------------------------------

--
-- Table structure for table `fixeddeposite`
--

CREATE TABLE `fixeddeposite` (
  `AccountNo` varchar(255) NOT NULL,
  `Duration` varchar(255) NOT NULL,
  `Amount` varchar(255) NOT NULL,
  `FDAccountNo` varchar(255) NOT NULL,
  `StartDate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `fixeddeposite`
--

INSERT INTO `fixeddeposite` (`AccountNo`, `Duration`, `Amount`, `FDAccountNo`, `StartDate`) VALUES
('8016174640924308', '13', '2000', '44033957557', '2017-11-30');
...
INSERT INTO `loan` (`AccountNo`, `LoanAmount`, `ReturnDate`, `Status`) VALUES
('8016174640924308', '3', '2017-12-10', 'NotPaid');
...
('8016174640924308', 'Deposite', '20171130082616', '40008', '2017-11-30'),
